...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (window.location.pathname.includes("tables_dynamic.html")) {
    ...
    setTimeout(() => {
      ...
      if (
        document.getElementById("datatable-checkbox") &&
        !$.fn.DataTable.isDataTable("#datatable-checkbox")
      ) {
      ...
      if (
        document.getElementById("datatable-fixed-header") &&
        !$.fn.DataTable.isDataTable("#datatable-fixed-header")
      ) {
      ...
      if (
        document.getElementById("datatable-keytable") &&
        !$.fn.DataTable.isDataTable("#datatable-keytable")
      ) {
      ...
      if (
        document.getElementById("datatable-responsive") &&
        !$.fn.DataTable.isDataTable("#datatable-responsive")
      ) {
